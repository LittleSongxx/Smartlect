...
export const routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: '/knowledge', name: 'knowledge', component: () => import('@/views/KnowledgeView.vue'), meta: { itemList: ['知识与服务', '知识库'] } },
      { path: '/support', name: 'support', component: () => import('@/views/SupportView.vue'), meta: { itemList: ['知识与服务', '人工客服'] } },
