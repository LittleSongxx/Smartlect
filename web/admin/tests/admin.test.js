...
const render = async component => { const wrapper = mount(component, { global: { components: { PageHeader, StatusTag, DetailText, JsonCollapse } } }); wrappers.push(wrapper); await flushPromises(); return wrapper; };
