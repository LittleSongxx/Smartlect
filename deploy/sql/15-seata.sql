-- Seata Server storeMode=db（官方 apache/incubator-seata script/server/db/mysql.sql）
USE smartlect_seata;
...
(
    ...
    -- 官方脚本为 VARCHAR(20)，但 lock_value 常为 ip:port（如 host.docker.internal:8091）会超长
